exports.run = async (client, message, args) => {
    ...
    if (args[0] === 'pedra' && rng > 0 && rng <= 34) {
        ...
        return message.channel.send('Papel, você perdeu! >:D ');
        ...
        return message.channel.send('Tesoura, você perdeu! >:D');
        ...
        return message.channel.send('Pedra, você perdeu! >:D');
    ...
    if (args[0] !== 'pedra' || args[0] !== 'papel' || args[0] !== 'tesoura') {
        return message.reply('insira `pedra`, `papel` ou `tesoura`.');
    }
